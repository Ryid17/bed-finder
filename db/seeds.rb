...
bed.photo.attach(io: file, filename: 'seed-bed.png', content_type: 'image/png')
bed.save
...
file = URI.open('https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQY0akhAWe5gnx8XfeaDD2S0eus4xd6odKeGq9fy9pJ8GiyD3BJ&usqp=CAU')
bed.photo.attach(io: file, filename: 'seed-bed.png', content_type: 'image/png')
bed.save
